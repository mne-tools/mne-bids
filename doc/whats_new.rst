...
- :func:`mne_bids.write_anat` to now take in :class:`mne_bids.BIDSPath` instead of entities as key word arguments, by `Adam Li`_ (`#543 <https://github.com/mne-tools/mne-bids/pull/543>`_)
