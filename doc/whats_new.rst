...
- Add a copyfile_ctf function in mne_bids.utils to copy and rename CTF files during mne_bids.write_raw_bids, by `Romain Quentin`_ (`#162 <https://github.com/mne-tools/mne-bids/pull/162>`_)
