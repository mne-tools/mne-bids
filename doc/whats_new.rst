...
- allow participants tsv and json files to persist user-modified data and keys when calling :func:`write_raw_bids` by `Adam Li`_ (`#442 <https://github.com/mne-tools/mne-bids/pull/442>`_)
