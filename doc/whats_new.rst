...
- Calling :func:`write_raw_bids` with `overwrite==True` will preserve participants.tsv and participants.json data for which no data to overwrite is present, by `Adam Li`_ (`#442 <https://github.com/mne-tools/mne-bids/pull/442>`_)
