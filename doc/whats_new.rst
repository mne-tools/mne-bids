...
- :func:`create_methods_paragraph` is now available from the `mne_bids` namespace that creates a string output of a summary of the BIDS dataset, by `Adam Li`_ (`#457 <https://github.com/mne-tools/mne-bids/pull/457>`_)
