...
:func:`mne_bids.get_head_mri_trans` gained a new parameter, ``landmark_names``, allowing to specify custom names used for the anatomical landmarks in the MRI data, by `Richard Höchenberger`_ (:gh:`946`)
