...
- :func:`read_raw_bids` will read in raw even if participants.tsv does not match mne-python standards, or if it does not exist, by `Adam  Li`_ (`#397 <https://github.com/mne-tools/mne-bids/pull/397>`_)
