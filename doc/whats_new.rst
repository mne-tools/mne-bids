...
- Add :func:`mne_bids.update.update_sidecar_json` to allow updating sidecar JSON files with a template JSON by `Adam Li`_ and `Austin Hurst`_ (`#601 <https://github.com/mne-tools/mne-bids/pull/601>`_)
