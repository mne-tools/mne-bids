...
- Add ``with_key`` keyword argument to :func:`mne_bids.get_entity_vals` to allow returning the full entity strings, by `Adam Li`_ (`#555 <https://github.com/mne-tools/mne-bids/pull/555>`_)
