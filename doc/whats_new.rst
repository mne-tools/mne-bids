...
- Fix a bug in :func:`mne_bids.write_raw_bids`, where original format of the data was not kept, by `Alexandre Gramfort`_, `Stefan Appelhoff`_, and `Richard Höchenberger`_ (`#610 <https://github.com/mne-tools/mne-bids/pull/610>`_)
