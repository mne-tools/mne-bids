...
- :func:`read_raw_bids` to read electrodes.tsv even if good channels don't have coordinates; warns if good channel and 'n/a' coordinate, by `Adam Li`_ (`#393 <https://github.com/mne-tools/mne-bids/pull/393>`_)
