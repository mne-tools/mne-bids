...
- :func:`mne_bids.read_raw_bids` now correctly populates the list of bad channels solely based on ``*_channels.tsv``, ignoring similar metadata stored in the raw file, by `Richard Höchenberger`_ (`#499 <https://github.com/mne-tools/mne-bids/pull/499>`_)
